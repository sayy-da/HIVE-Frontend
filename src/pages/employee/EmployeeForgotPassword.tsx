...
import { forgotPasswordEmployee } from '../../API/employee.api'
...
function EmployeeForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await forgotPasswordEmployee(email, companyid);
      navigate(`/employee/verify-otp-reset?companyid=${companyid}`, { 
        state: { email, companyId: companyid },
        replace: true 
      });
    } catch (error: any) {
